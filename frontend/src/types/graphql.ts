...
export type Search_Post_QueryQuery = { __typename?: 'Query', getSearchPost: Array<{ __typename?: 'Post', id: string, title: string, user: { __typename?: 'User', username: string, id: string } } | null> };
