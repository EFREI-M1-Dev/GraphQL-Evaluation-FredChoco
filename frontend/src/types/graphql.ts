...
export type User_Post_QueryQuery = { __typename?: 'Query', getUserPosts: Array<{ __typename?: 'Post', content: string, createdAt: any, id: string, title: string, imagePath: string, user: { __typename?: 'User', id: string, username: string } } | null> };
...
export type UpdateUserMutation = { __typename?: 'Mutation', updateUser: { __typename?: 'UserUpdateResponse', code: number, message: string, success: boolean } };
